...
public class JWTAuthFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        if (userName != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (JWTService.validateToken(jwtToken, user) && JWTService.getUserRole(jwtToken).equals("user") || JWTService.getUserRole(jwtToken).equals("userAdmin") || JWTService.getUserRole(jwtToken).equals("packageDetailsAdmin") || JWTService.getUserRole(jwtToken).equals("paymentAdmin")|| JWTService.getUserRole(jwtToken).equals("GuideAdmin")|| JWTService.getUserRole(jwtToken).equals("HotelAdmin")|| JWTService.getUserRole(jwtToken).equals("packageAdmin")|| JWTService.getUserRole(jwtToken).equals("vehicleAdmin")) {
