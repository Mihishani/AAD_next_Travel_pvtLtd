...
//            System.out.println(packages);
    ...
    public Response getAll() {
        ...
        if (!packages.isEmpty()) {
            ArrayList<PackageDTO> packagesDtos = new ArrayList<>();
            packages.forEach((packagess) -> {
                packagesDtos.add(modelMapper.map(packagess, PackageDTO.class));
            });
            return createAndSendResponse(HttpStatus.FOUND.value(), "Packages Successfully retrieved!", packagesDtos);
        }
